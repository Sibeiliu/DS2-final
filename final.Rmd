...
T1=data.frame(model=c("GLM","GLMN","LDA","QDA","KNN"),Error_rate=c(glm,glmn,lda,qda,knn)) %>% knitr::kable()
T1
```
...
T2=data.frame(model=c("GLM","GLMN","LDA","QDA","KNN"),Error_rate=c(glm1,glmn1,lda1,qda1,knn1)) %>% knitr::kable()
T2
```
