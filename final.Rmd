...
```{r}
glm=1-sum(predict(model.glm, newdata = wine[-rowtrain,]) %>% as.data.frame()==wine[-rowtrain,12])/nrow(wine[-rowtrain,])
knn=1-sum(predict(model.knn, newdata = wine[-rowtrain,])%>% as.data.frame()==wine[-rowtrain,12])/nrow(wine[-rowtrain,])
glmn=1-sum(predict(model.glmn, newdata = wine[-rowtrain,])%>% as.data.frame()==wine[-rowtrain,12])/nrow(wine[-rowtrain,])
lda =1-sum(predict(model.lda, newdata = wine[-rowtrain,])%>% as.data.frame()==wine[-rowtrain,12])/nrow(wine[-rowtrain,])
qda =1-sum(predict(model.qda, newdata = wine[-rowtrain,])%>% as.data.frame()==wine[-rowtrain,12])/nrow(wine[-rowtrain,])
nb = 1-sum(predict(model.nb, newdata = wine[-rowtrain,])%>% as.data.frame()==wine[-rowtrain,12])/nrow(wine[-rowtrain,])
...
glm1=1-sum(predict(model.glm, newdata = wine[rowtrain,]) %>% as.data.frame()==wine[rowtrain,12])/nrow(wine[rowtrain,])
knn1=1-sum(predict(model.knn, newdata = wine[rowtrain,])%>% as.data.frame()==wine[rowtrain,12])/nrow(wine[rowtrain,])
glmn1=1-sum(predict(model.glmn, newdata = wine[rowtrain,])%>% as.data.frame()==wine[rowtrain,12])/nrow(wine[rowtrain,])
lda1 =1-sum(predict(model.lda, newdata = wine[rowtrain,])%>% as.data.frame()==wine[rowtrain,12])/nrow(wine[rowtrain,])
qda1 =1-sum(predict(model.qda, newdata = wine[rowtrain,])%>% as.data.frame()==wine[rowtrain,12])/nrow(wine[rowtrain,])
nb1 =1-sum(predict(model.nb, newdata = wine[rowtrain,])%>% as.data.frame()==wine[rowtrain,12])/nrow(wine[rowtrain,])
